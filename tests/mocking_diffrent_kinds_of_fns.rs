...
// methods               ~ 4 generic combinations * 4 self variants = 16 TODO          4+4+4+1=13/16
// trait methods         ~ 8 generic combinations * 4 self variants = 32 TODO  0+0+0+0+0+0+0+0=00/32
// default trait methods ~ 8 generic combinations * 4 self variants = 32 TODO  0+0+0+0+0+0+0+0=00/32
// directory + mod file      file                     test          = 82                       15/82
