...
// methods               ~ 4 generic combinations * 4 self variants = 16 TODO  0*0=00/16
...
// naming: fn - function, struct - Struct, trait - Trait
// tested fn has <self if method> + 1 + <1 if fn generic> + <1 if trait generic> Display args
// final fn args list should be u8, bool, f32, char
